...
from utils.lovasz_loss import ReportLovaszLoss
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='gamma_stem_wst1fea_513_2dot0_scratch')
    # Datasets
...
def main(args):
    ...
    criterion = ReportLovaszLoss(ignore_index=args.ignore_label, only_present=True)
