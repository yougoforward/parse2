...
from network.gatenet import get_model
from progress.bar import Bar
from utils.lovasz_loss import GateLovaszLoss
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='aspnet_stem_grid_st1fea_gate_ob')
    # Datasets
...
def main(args):
    ...
    criterion = GateLovaszLoss(ignore_index=args.ignore_label, only_present=True, weight_rate=1.5, target_rate=0.8)
