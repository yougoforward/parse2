...
from dataset.datappss import DatasetGenerator
from network.gatingnet import get_model
from progress.bar import Bar
from utils.lovasz_loss import PPSSLoss
...
def parse_args():
    ...
    # Datasets
    parser.add_argument('--root', default='/home/ubuntu/Data/PPSS/TrainData/', type=str)
    parser.add_argument('--val-root', default='/home/ubuntu/Data/PPSS/TestData/', type=str)
...
def main(args):
    ...
    criterion = PPSSLoss(ignore_index=args.ignore_label, only_present=True, weight_rate=1.5, target_rate=0.7)
