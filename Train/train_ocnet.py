...
from utils.lovasz_loss import LovaszSoftmaxLoss
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='se_ocnet_stem_dsn_fres2_lovasz')
    # Datasets
...
def main(args):
    ...
    criterion = LovaszSoftmaxLoss(ignore_index=args.ignore_label, only_present=True)
