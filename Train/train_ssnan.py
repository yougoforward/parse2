...
def parse_args():
    ...
    parser.add_argument('--decoder-lr', type=int, default=10)
    parser.add_argument('--ignore-label', type=int, default=255)
    # Checkpoints
    parser.add_argument('--restore-from', default='./checkpoints/init/resnet101.pth', type=str)
...
def adjust_learning_rate(optimizer, epoch, i_iter, iters_per_epoch, method='poly'):
    ...
    optimizer.param_groups[1]['lr'] = lr * args.decoder_lr
    return lr
...
def main(args):
    ...
    optimizer = optim.SGD(
        [{'params': seg_model.encoder.parameters(), 'lr': args.learning_rate},
         {'params': seg_model.decoder.parameters(), 'lr': args.learning_rate * args.decoder_lr}],
