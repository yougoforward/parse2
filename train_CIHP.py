...
from dataset.data_CIHP import DatasetGenerator, ValidationLoader
from network.gamanet_fea import get_model
from progress.bar import Bar
from utils.lovasz_loss import CIHPLoss
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='gamma_stem_wst1fea_CIHP')
    # Datasets
    parser.add_argument('--root', default='/home/ubuntu/Data/CIHP/', type=str)
    parser.add_argument('--val-root', default='/home/ubuntu/Data/LIP/val_set/', type=str)
    parser.add_argument('--lst', default='./dataset/CIHP/all_id.txt', type=str)
    ...
    parser.add_argument('--snapshot_dir', type=str, default='./checkpoints/exp_workshop/')
    parser.add_argument('--log-dir', type=str, default='./runs/workshop/')
...
def main(args):
    ...
    val_loader = data.DataLoader(ValidationLoader(root=args.val_root, list_path=args.val_lst,
                                                  crop_size=args.crop_size),
                                 batch_size=args.batch_size, shuffle=False, num_workers=4, pin_memory=True)

    # define criterion & optimizer
    criterion = CIHPLoss(ignore_index=args.ignore_label, only_present=True)
