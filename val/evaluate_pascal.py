...
from dataset.data_person import TestGenerator
# from network.fullfusenet import get_model
from network.abr_gnn_att21 import get_model
...
def get_arguments():
    ...
    # parser.add_argument("--restore-from", type=str, default='./checkpoints/exp/abr_person_fullfuse_miou.pth')
    parser.add_argument('--restore-from', default='./checkpoints/exp/abr_gnn_att21_miou68.75.pth', type=str)
