...
class DecoderModule2(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.decoder = DecoderModule3(256,256,128,256)
...
class DecoderModule3(nn.Module):
    ...
    def __init__(self, in_dim1=256, in_dim2=256, inter_dim=128, out_dim=256):
        ...
        self.refine = nn.Sequential(
            nn.Conv2d(inter_dim+48, inter_dim, kernel_size=3, padding=1, dilation=1, bias=False), BatchNorm2d(inter_dim), nn.ReLU(inplace=False),
