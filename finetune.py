...
from utils.lovasz_loss import FinetuneLovaszLoss
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='gamma_stem_wst1fea_CIHP_base_trainval_fine_2dot0_200e_nodsn')
    # Datasets
    ...
    parser.add_argument('--restore-from',
                        default='./checkpoints/exp_workshop/gamma_stem_wst1fea_CIHP_miou.pth', type=str)
...
def main(args):
    ...
    criterion = FinetuneLovaszLoss(ignore_index=args.ignore_label, only_present=True)
