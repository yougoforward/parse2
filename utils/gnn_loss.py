...
class gnn_loss(nn.Module):
    ...
    def forward(self, preds, targets):
        ...
        #        0.1*(loss_fh_att + loss_up_att + loss_lp_att + loss_com_att + loss_dp_att) + 0.4 * loss_dsn
        # return (loss + 0.4 * loss_hb + 0.4 * loss_fb)/len(preds[1]) + 0.4 * loss_dsn
        return (loss + 0.4*loss_hb + 0.4*loss_fb)/len(preds[1]) + 0.2 * loss_dsn + 0.1*(loss_fh_att + loss_up_att + loss_lp_att + loss_com_att)/len(preds[1])
class gnn_loss_dp(nn.Module):
    ...
    def forward(self, preds, targets):
        ...
        #        0.1*(loss_fh_att + loss_up_att + loss_lp_att + loss_com_att + loss_dp_att) + 0.4 * loss_dsn
        # return (loss + 0.4 * loss_hb + 0.4 * loss_fb)/len(preds[1]) + 0.4 * loss_dsn
        return (loss + 0.4*loss_hb + 0.4*loss_fb)/len(preds[1]) + 0.4 * loss_dsn + 0.4*(loss_fh_att + loss_up_att + loss_lp_att + loss_com_att + loss_dp_att)/len(preds[1])
